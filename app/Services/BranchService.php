...
class BranchService
{
    ...
    public function branch_winner_date($branch_id)
    {
        ...
        return $result = [
            ...
            'Cantidad del Servicio' => $service ? $service['orders_count'] : 0,
    ...
    public function branch_winner_month($branch_id, $month, $year)
    {
        ...
        $products = Product::with([
            ...
            'cashiersales' => function ($query) use ($branch_id, $year, $month) {
    ...
    public function branch_winner_periodo_icon($branch_id, $startDate, $endDate)
    {
        ...
        $result = [
            ...
            'Clientes Atendidos' => $totalClients,
            'Monto Generado' => round($cars->sum('amount') + ($cars->sum('technical_assistance') * 5000) + $productSales, 2),
            'Utilidades' => round($totalUtilidadProducts + $utilidadServices + $coffe, 2),
        ...
        $iconColorMapping = [
            ...
            '10% Propina' => ['icon' => 'mdi-cash', 'color' => 'blue'],
    ...
    public function branch_professionals_winner_date($branch_id)
    {
        ...
        foreach ($professionals as $professional) {
            ...
            $dates[] =  [
                ...
                'renta' => $winProfessional + $bonus,
                'total' => ($winProfessional - $retentionPorcent) + $winTips + $bonusRetention,
