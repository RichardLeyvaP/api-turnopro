...
Route::group(['middleware' => ["auth:sanctum"]], function () {
    ...
    //ProfessionalPayment
    Route::get('/branch-payment-show-bonus', [ProfessionalPaymentController::class, 'branch_payment_show_bonus']); //devolver de una branch los pagos de bonus realizado a los professionals
    ...
    Route::post('/branchruleprofessional-state', [BranchRuleProfessionalController::class, 'update_rule_state']);
...
Route::get('/course', [CourseController::class, 'index']); //se usa en la landing
