...
@if ($data !== date('Y-m-d'))
<p style="color: #333;">
    &#x1F64F; ¡Gracias por elegir Simplifies! has click en el botón de abajo para cancelar tu reserva.
</p>
...
@if ($data !== date('Y-m-d'))
<p style="color: #555;">
    &#x1F917; Por favor, has click en el botón de abajo para cancelar tu reserva.
</p>
