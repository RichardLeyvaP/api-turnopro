...
<div class="sl-elements sl-antialiased sl-h-full sl-text-base sl-font-ui sl-text-body sl-flex sl-inset-0">
    ...
    <div class="sl-flex sl-overflow-y-auto sl-flex-col sl-flex-grow sl-flex-shrink">
                        ...
                        <div title="Authenticating requests" id="toc-item-authenticating-requests"
                            ...
                            <a href="#authenticating-requests"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">Authenticating requests</a>
                                    ...
                                    <div class="expandable">
                        <div title="Landing" id="toc-item-landing"
                             class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-4 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none">
                            <a href="#landing"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">Landing</a>
                                    ...
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                        ...
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-landing-GETapi-course">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="index">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#landing-GETapi-course">
                                                    index
                                                </a>
                                            </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-landing-POSTapi-course-student-landing">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="store_landing">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#landing-POSTapi-course-student-landing">
                                                    store_landing
                                                </a>
                                            </div>
                                                                                    </div>
        ...
        <div class="sl-flex sl-items-center sl-px-4 sl-py-3 sl-border-t">
            Última actualización: July 24, 2024
        </div>
...
<p>Usted puede obtener su token usando unas credenciales válidas para el Endpoint <b>Login</b>.</p>
            </div>
        </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="https://api2.simplifies.cl/api/course"
                ...
                >
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">https://api2.simplifies.cl</div>
                        <div class="sl-flex-1 sl-font-semibold">/api/course</div>
                    </div>

                                    </div>
        </div>

        <p>Mostrar los cursos</p>
    </div>
    <div class="sl-flex">
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                                        <div class="sl-flex sl-items-baseline sl-text-base">
                    <div class="sl-font-mono sl-font-semibold sl-mr-2">Accept-Language</div>
                                    </div>
                                    </div>
                                            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                <span>Example:</span> <!-- <span> important for spacing -->
        ...
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              ...
              data-hasjsonbody="0">
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                                       ...
                                       for="header-GETapi-course-Content-Type">Content-Type</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Content-Type" name="Content-Type"
                                               id="header-GETapi-course-Content-Type"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-GETapi-course-Accept">Accept</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept" name="Accept"
                                               id="header-GETapi-course-Accept"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-GETapi-course-Accept-Language">Accept-Language</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept-Language" name="Accept-Language"
                                               id="header-GETapi-course-Accept-Language"
                                               value="es" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                    </div>
            ...
            <div class="SendButtonHolder sl-mt-4 sl-p-4 sl-pt-0">
                <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-center">
                    <button type="button" data-endpoint="GETapi-course"
            ...
            <div data-endpoint="GETapi-course"
...
You can check the Dev Tools console for debugging information.</p>
    ...
    "https://api2.simplifies.cl/api/course"
);
...
$url = 'https://api2.simplifies.cl/api/course';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
response.json()</code></pre>                                        </div>
    ...
    --header "Accept-Language: es"</code></pre>                                        </div>
                                    </div>
                                </div>
                                                    </div>
                                    ...
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-GETapi-course-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('GETapi-course', event.target.value);">
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-GETapi-course example-response-GETapi-course-0"
                                     style=" "
                                >
    ...
    &quot;course&quot;: {
        ...
        &quot;description(descripci&oacute;n del curso)&quot;: &quot;kslfksf&quot;,
        ...
        &quot;reservation_price(precio de reservaci&oacute;n del curso)&quot;: 12000,
        &quot;duration(duraci&oacute;n del curso)&quot;: 10,
        ...
        &quot;enrollment(datos de la academia del curso)&quot;: {
            ...
            &quot;description(descripci&oacute;n de la academia)&quot;: &quot;Cursos de barberia B&aacute;sicos y avanzados&quot;,
            &quot;created_at&quot;: &quot;2024-03-25T09:30:12.000000Z&quot;,
            &quot;updated_at&quot;: &quot;2024-05-17T00:03:52.000000Z&quot;,
            &quot;location(localizaci&oacute;n de google map de la academia)&quot;: &quot;dwqdqwdwqqwqd&quot;,
            &quot;image_data(imagen de la academia)&quot;: &quot;enrollments/4.jpg&quot;,
            &quot;address(direcci&oacute;n de la academia)&quot;: &quot;qwwqwqdqwd&quot;,
            &quot;phone(tel&eacute;fono de la academia)&quot;: 56949879923
        }
    }
}</code></pre>
                                                                            </div>
                                </div>
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-GETapi-course example-response-GETapi-course-1"
                                     style=" display: none;"
                                >
                                    <div class="sl-panel__content sl-p-0">                                                                                                                                
                                            <pre><code style="max-height: 300px;"
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="landing-POSTapi-course-student-landing">
                    store_landing
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div title="https://api2.simplifies.cl/api/course-student-landing"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">https://api2.simplifies.cl</div>
                        <div class="sl-flex-1 sl-font-semibold">/api/course-student-landing</div>
                    </div>

                                    </div>
        </div>

        <p>Matricular estudiante al curso</p>
    </div>
    <div class="sl-flex">
        <div data-testid="two-column-left" class="sl-flex-1 sl-w-0">
            <div class="sl-stack sl-stack--vertical sl-stack--10 sl-flex sl-flex-col sl-items-stretch">
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                                        <div class="sl-flex sl-items-baseline sl-text-base">
                    <div class="sl-font-mono sl-font-semibold sl-mr-2">course_id</div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                ...
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
            <p>nombre y apellido del estudiante</p>
        </div>
                                            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                <span>Example:</span> <!-- <span> important for spacing -->
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                                        <div class="sl-flex sl-items-baseline sl-text-base">
                    <div class="sl-font-mono sl-font-semibold sl-mr-2">client_image</div>
                                            <span class="sl-truncate sl-text-muted">file</span>
                                    </div>
                                    </div>
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
            <p>imagen del estudiante</p>
        </div>
                                            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                <span>Example:</span> <!-- <span> important for spacing -->
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                                        <div class="sl-flex sl-items-baseline sl-text-base">
                    <div class="sl-font-mono sl-font-semibold sl-mr-2">fie</div>
                                            <span class="sl-truncate sl-text-muted">file</span>
                                    </div>
                                    </div>
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
    ...
    <div class="sl-overflow-y-hidden sl-rounded-lg">
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              data-method="POST"
              data-path="api/course-student-landing"
              data-hasfiles="1"
              data-hasjsonbody="0">
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-course-student-landing-Content-Type">Content-Type</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Content-Type" name="Content-Type"
                                               id="header-POSTapi-course-student-landing-Content-Type"
                                               value="multipart/form-data" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-course-student-landing-Accept">Accept</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept" name="Accept"
                                               id="header-POSTapi-course-student-landing-Accept"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-course-student-landing-Accept-Language">Accept-Language</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept-Language" name="Accept-Language"
                                               id="header-POSTapi-course-student-landing-Accept-Language"
                                               value="es" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                                                    <div class="ParameterGrid sl-p-4">
                                                                                                        <label aria-hidden="true"
                                           for="bodyparam-POSTapi-course-student-landing-course_id">course_id</label>
                                    <span class="sl-mx-3">:</span>
                                    <div class="sl-flex sl-flex-1">
                                        <div class="sl-input sl-flex-1 sl-relative">
                                                                                            <input aria-label="course_id" name="course_id"
                                                       id="bodyparam-POSTapi-course-student-landing-course_id"
                                                       placeholder="id del curso"
                                                       value="5" data-component="body"
                                                       class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border"
                                                >
                                                                                    </div>
                                    </div>
                                                                                                        <label aria-hidden="true"
                                           for="bodyparam-POSTapi-course-student-landing-name">name</label>
                                    <span class="sl-mx-3">:</span>
                                    <div class="sl-flex sl-flex-1">
                                        <div class="sl-input sl-flex-1 sl-relative">
                                                                                            <input aria-label="name" name="name"
                                                       id="bodyparam-POSTapi-course-student-landing-name"
                                                       placeholder="nombre y apellido del estudiante"
                                                       value="Pepe Rosales Mora" data-component="body"
                                                       class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border"
                                                >
                                                                                    </div>
                                    </div>
                                                                                                        <label aria-hidden="true"
                                           for="bodyparam-POSTapi-course-student-landing-phone">phone</label>
                                    <span class="sl-mx-3">:</span>
                                    <div class="sl-flex sl-flex-1">
                                        <div class="sl-input sl-flex-1 sl-relative">
                                                                                            <input aria-label="phone" name="phone"
                                                       id="bodyparam-POSTapi-course-student-landing-phone"
                                                       placeholder="teléfono del estudiante"
                                                       value="+56912345678" data-component="body"
                                                       class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border"
                                                >
                                                                                    </div>
                                    </div>
                                                                                                        <label aria-hidden="true"
                                           for="bodyparam-POSTapi-course-student-landing-email">email</label>
                                    <span class="sl-mx-3">:</span>
                                    <div class="sl-flex sl-flex-1">
                                        <div class="sl-input sl-flex-1 sl-relative">
                                                                                            <input aria-label="email" name="email"
                                                       id="bodyparam-POSTapi-course-student-landing-email"
                                                       placeholder="correo del estudiante"
                                                       value="ejemplo@gmail.com" data-component="body"
                                                       class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border"
                                                >
                                                                                    </div>
                                    </div>
                                                                                                        <label aria-hidden="true"
                                           for="bodyparam-POSTapi-course-student-landing-client_image">client_image</label>
                                    <span class="sl-mx-3">:</span>
                                    <div class="sl-flex sl-flex-1">
                                        <div class="sl-input sl-flex-1 sl-relative">
                                                                                            <input aria-label="client_image" name="client_image"
                                                       id="bodyparam-POSTapi-course-student-landing-client_image"
                                                ...
                                                >
                                                                                                        ...
                                                                                                        <label aria-hidden="true"
                                           for="bodyparam-POSTapi-course-student-landing-fie">fie</label>
                                    <span class="sl-mx-3">:</span>
                                    <div class="sl-flex sl-flex-1">
                                        <div class="sl-input sl-flex-1 sl-relative">
                                                                                            <input aria-label="fie" name="fie"
                                                       id="bodyparam-POSTapi-course-student-landing-fie"
                                                       type="file" data-component="body"
                                                       class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border"
                                                >
                                                                                    </div>
            ...
            <div class="SendButtonHolder sl-mt-4 sl-p-4 sl-pt-0">
                <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-center">
                    <button type="button" data-endpoint="POSTapi-course-student-landing"
                            class="tryItOut-btn sl-button sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-bg-primary hover:sl-bg-primary-dark active:sl-bg-primary-darker disabled:sl-bg-canvas-100 sl-text-on-primary disabled:sl-text-body sl-rounded sl-border-transparent sl-border disabled:sl-opacity-70"
                    >
                        Send Request 💥
                    </button>
            ...
            <div data-endpoint="POSTapi-course-student-landing"
                 class="tryItOut-error expandable sl-panel sl-outline-none sl-w-full" hidden>
                <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-4 sl-pl-3 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-cursor-pointer sl-select-none"
                     role="button">
                    <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                            ...
                            <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                                <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-javascript">const url = new URL(
    "https://api2.simplifies.cl/api/course-student-landing"
);
...
body.append('client_image', document.querySelector('input[name="client_image"]').files[0]);
...
fetch(url, {
    ...
    body,
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://api2.simplifies.cl/api/course-student-landing';
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'name',
                'contents' =&gt; 'Pepe Rosales Mora'
            ],
            [
                'name' =&gt; 'phone',
                'contents' =&gt; '+56912345678'
            ],
            [
                'name' =&gt; 'email',
                'contents' =&gt; 'ejemplo@gmail.com'
            ],
            [
                'name' =&gt; 'client_image',
...
response.json()</code></pre>                                        </div>
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-POSTapi-course-student-landing-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('POSTapi-course-student-landing', event.target.value);">
                                                                                                            <option value="0">200</option>
                                                                                                            <option value="1">500</option>
                                                                                                    </select></div>
                                        </div>
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-POSTapi-course-student-landing example-response-POSTapi-course-student-landing-0"
                                     style=" "
                                >
                                    <div class="sl-panel__content sl-p-0">                                                                                                                                
                                            <pre><code style="max-height: 300px;"
    ...
    &quot;msg&quot;: &quot;Estudiante matriculado correctamente al curso&quot;
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-POSTapi-course-student-landing example-response-POSTapi-course-student-landing-1"
                                     style=" display: none;"
                                >
                                    <div class="sl-panel__content sl-p-0">                                                                                                                                
                                            <pre><code style="max-height: 300px;"
